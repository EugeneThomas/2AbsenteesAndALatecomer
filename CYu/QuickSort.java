 ...
 *    If the array is already sorted O(n^2)
 * 2b. Best pivot choice / array state and associated runtime:
 *    Position in middle or array, random number O(n)
...
public class QuickSort 
{
    ...
    public static void qHelper(int[] d, int left, int right){
		int pvtPos = (left + right) / 2;		
	
		if(left < right){
			pvtPos = partition(d, left, right, pvtPos);
			qHelper(d, left, pvtPos-1);
			qHelper(d, pvtPos+1, right);
		}
    }
